...
setTimeout(()=>{
    ...
    document.getElementById('tituloBarra').innerHTML=` Duracion video  4:41`},100);
...
function iniciar(){
    var imagenes=document.querySelectorAll('#cajaimagenes img');
     soltar=document.getElementById('primerCaja');  
     soltar2  =document.getElementById('segundaCaja'); 
     soltar3 = document.getElementById('terceraCaja'); 
